...
export const environment = {
  production: false,
  apiServerUrl: 'http://127.0.0.1:5000/login', // the running FLASK api server url
  auth0: {
    ...
    callbackURL: 'http://127.0.0.1:5000/login_result', // the base url of the running ionic application. 
  }
};
